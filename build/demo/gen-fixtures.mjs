...
state.version ??= "0.9.67";
state.displayVersion ??= "v0.9.67";
...
const about = readCap("about.json", { appName: "Boolean", version: "0.9.67", displayVersion: "v0.9.67", channel: "Stable", repository: "https://github.com/syfy10/Boolean", sourceAvailable: true });
