...
state.version ??= "0.9.68";
state.displayVersion ??= "v0.9.68";
...
const about = readCap("about.json", { appName: "Boolean", version: "0.9.68", displayVersion: "v0.9.68", channel: "Stable", repository: "https://github.com/syfy10/Boolean", sourceAvailable: true });
