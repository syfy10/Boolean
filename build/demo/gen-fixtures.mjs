...
const about = readCap("about.json", { appName: "Boolean", version: "0.9.60", displayVersion: "v0.9.60", channel: "Stable", repository: "https://github.com/syfy10/Boolean", sourceAvailable: true });
