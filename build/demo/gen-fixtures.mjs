...
state.version ??= "0.9.69";
state.displayVersion ??= "v0.9.69";
...
const about = readCap("about.json", { appName: "Boolean", version: "0.9.69", displayVersion: "v0.9.69", channel: "Stable", repository: "https://github.com/syfy10/Boolean", sourceAvailable: true });
