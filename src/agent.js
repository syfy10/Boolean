...
function cleanSystemPrompt(projectsDir, fullAccess, connectors, learned) {
  return [
    ...
    "- For Gmail cleanup, always call email_cleanup_preview first. It is read-only and returns a saved plan. Only call email_cleanup_trash after the user explicitly confirms a batch; it re-checks protection rules and moves mail to Trash. Use email_cleanup_undo to restore a batch. Boolean has no permanent-delete email tool.",
