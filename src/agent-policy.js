...
export const BOOLEAN_AGENT_RULES = Object.freeze([
  ...
  "For non-trivial coding work, map the repository around the task, identify exact symbols and tests, then read only the relevant line ranges before editing.",
  ...
  "Treat failed commands, compiler output, and test failures as new evidence: change the hypothesis or patch before retrying, and preserve the last known-good checkpoint.",
